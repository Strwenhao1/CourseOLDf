...
import com.coursemis.util.EditSms;
import com.coursemis.util.HttpUtil;
import com.coursemis.util.quxian;
import com.coursemis.util.zhuxing;
...
public class EvaluateGetActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		xingList.setOnItemClickListener(new OnItemClickListener() {
					...
					client.post(HttpUtil.server_evaluate_zhu_get, params,
							new JsonHttpResponseHandler() {
								...
								public void onSuccess(int arg0, JSONObject arg1) {
									...
									Intent intent = new zhuxing().execute(
											context, grade_zhuxing,
											year_zhuxing);
					...
					client.post(HttpUtil.server_evaluate_get, params,
							new JsonHttpResponseHandler() {
								...
								public void onSuccess(int arg0, JSONObject arg1) {
									...
									Intent intent = new quxian().execute(
					...
					client.post(HttpUtil.server_evaluate_Sms_get, params,
							new JsonHttpResponseHandler() {
								...
								public void onSuccess(int arg0, JSONObject arg1) {
									...
									Intent achartIntent = new EditSms()
	 ...
	 * zhuxing().execute(context, grade_zhuxing, year_zhuxing);
	 ...
	 * quxian().execute(context,years,points); startActivity(intent);
	 * super.onSuccess(arg0, arg1); }
	 * 
	 * });
	 * 
	 ...
	 * EditSms().execute(context,personnum); startActivity(achartIntent);
	 * super.onSuccess(arg0, arg1); }
	 * 
	 * });
	 * 
